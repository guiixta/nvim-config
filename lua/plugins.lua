...
require('nvim-treesitter').setup({
	ensure_installed = { 'rust', 'javascript', 'typescript', 'jsx', 'tsx', 'zig', 'php', 'blade', 'lua', 'html' },
	highlight = {
		enable = true,
	},
})
...
-- atalhos globais
vim.keymap.set("n", "<C-t>", function() require("nvim-tree.api").tree.toggle() end,
	{ desc = "Toggle Tree", silent = true })
...
vim.keymap.set({ 'n', 'i' }, "<C-LeftMouse>", "<Cmd>MultipleCursorsMouseAddDelete<CR>",
	{ desc = "Adicionar/Remover cursor no clique" })
...
vim.keymap.set('x', "<leader>m", "<Cmd>MultipleCursorsAddVisualArea<CR>",
	{ desc = "Adicionar cursores nas linhas selecionadas" })
